      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="spuNum" @change="inputRight">
                <a href="javascript:" class="plus" @click="spuNum++">+</a>
                <a href="javascript:" class="mins" @click="spuNum>1?spuNum--:1">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    ...
    async addshopcar(){
      try{
        await this.$store.dispatch("AddOrUpdateShopCart",{skuId:this.$route.params.skuid,skuNum:this.spuNum})
