  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllChecked&&cartInfoList.length>0" @click="clickIsAllChecked($event)">
        <span>全选</span>
      </div>
      <div class="option">
...
export default {
  ...
  methods: {
    ...
    async deleteCheckedCart(){
      try{
        await this.$store.dispatch("deleteCheckedSkuId")
        this.getData()
      }catch(error){
        alert(error.message)
      }
